...
import TriggerButton from '../automations/triggerButton'
import { AUTOMATION_LISTENERS } from '@/constants/menu'
...
const ThenAction = ({id}:{id:string}) => {
  const {onSetListener , register , onFormSubmit , listner:Listener , isPending} = useListener(id)
  return (
